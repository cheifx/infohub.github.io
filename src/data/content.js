...
// Export generated on 2025-11-12T13:02:30.899Z
export let contentData = {
  "landing": {
    ...
    "newsItems": [
      ...
      {
        "id": 3,
        "title": "Success Story: Streamlined digital failure investigation flow",
        "content": "See how a digital interface with a simplified failure verification guide on what are the recommended steps to be performed independently could help us improve the workflow.",
        "author": "Emily Watson",
        "date": "2025-10-25",
      ...
      {
        "id": 4,
        "title": "Upcoming Event: Agile Introduction",
        "content": "Join us for an interactive introduction workshop on Agile Project Management fundamentals. Perfect for teams starting their agile journey. Registration opens next week.",
        "author": "Sayed Abouelela",
        "date": "2025-10-22",
        "category": "Event",
        "likes": 80,
        "comments": 6,
  ...
  "about": {
    ...
    "businessGoals": [
      {
        "goal": "Increase operational efficiency by 30%",
        "progress": 65
      },
      {
        "goal": "Improve customer satisfaction scores by 25%",
        "progress": 72
      },
      {
      ...
      {
        "goal": "Achieve 80% employee engagement in digital initiatives",
        "progress": 67
      },
      {
        "goal": "Generate 5M Euro in cost savings through automation",
        "progress": 45
      }
    ],
    "timeline": [
      {
        "phase": "Wave 1: Align & Visualize",
        "period": "Q4 2025",
        "status": "in-progress",
        "description": "Preparation: Establish core team, define vision, set up infrastructure.\nExecution: Alignment on Digital Transformation & Visualize portfolio"
      },
      {
        "phase": "Wave 2: Focus",
        "period": "Q1-Q3 2026",
        "status": "planned",
        "description": "Prioritize on the portfolio and have clear focus on completing the topics."
      },
      {
        "phase": "Wave 3: Innovate",
        "period": "From Q1 2026",
        "status": "planned",
        "description": "Use Lean Startup Cycle to guide new initiative for the think tanks."
      },
      {
        "phase": "Wave 4: Sustain",
        "period": "From 2027",
        "status": "planned",
        "description": "Ensure sustainable change in the organization."
      }
    ],
    "team": [
      {
      ...
      },
      {
        ...
        "department": "DT WOW ACE"
      },
      {
        "name": "Sayed Abouelela",
        "role": "Transformation Coach",
        "department": "DT WOW ACE"
      },
      {
    ...
    "processSteps": [
      {
        "step": "1",
        "title": "Align & Visualize",
        "description": "Align on strategy, visualize portfolio"
      },
      {
        "step": "2",
        "title": "Focus",
        "description": "Iteratively complete ongoing topics"
      },
      {
        "step": "3",
        "title": "Innovate",
        "description": "Realize new initiatives using Lean Startup Cycle"
      },
      {
        "step": "4",
        "title": "Sustain",
        "description": "Ensure sustainable change effect in RPT"
      }
    ]
  },
  "portfolio": {
    ...
    "tabs": [
      {
        "id": "data-strategy",
        "label": "Data Strategy",
        "description": "Initiatives focused on data governance, analytics, and strategic data utilization."
      },
      {
        "id": "standardization",
        "label": "Standardization",
        "description": "Projects aimed at standardizing processes, systems, and practices across the organization."
      },
      {
        "id": "digitalization",
        "label": "Digitalization",
        "description": "Efforts to digitize operations, enhance digital capabilities, and drive digital innovation."
      }
    ],
    ...
    "initiatives": [
      ...
      },
      {
        ...
        "resources": [
          {
            "type": "Guide",
            "title": "Process Standardization Playbook",
            "url": "#"
          },
          {
            "type": "Template",
      ...
      },
      {
        ...
        "resources": [
          ...
          {
            "type": "Case Study",
            "title": "Standardization Success Stories",
            "url": "#"
          }
        ],
        "rating": 4.5,
      ...
      },
      {
        ...
        "resources": [
          ...
          {
            "type": "Case Study",
            "title": "Customer Portal Success Story",
            "url": "#"
          }
        ],
        "rating": 4.8,
    ...
    "frameworks": [
      ...
      },
      {
        ...
        "resources": [
          ...
          {
            "type": "Tool",
            "title": "Experiment Tracking Sheet",
            "url": "#"
          }
        ]
      },
  ...
  "contact": {
    ...
    "contactInfo": [
      {
        "title": "Email",
        "content": "rpt-digital-transformation@infineon.com",
    ...
    "teamMembers": [
      {
        "name": "Thomas Gombocz",
        "role": "Transformation Lead",
        "email": "thomas.gombocz@infineon.com"
      },
      {
        "name": "Che Liu",
        "role": "Transformation Coach",
        "email": "che.liu@infineon.com"
      },
      {
        "name": "Sayed Abouelela",
        "role": "Transformation Coach",
        "email": "sayed.abouelela@infineon.com"
      }
    ],
    "responseTimes": {
      "high": "Within 8 hours",
  ...
  "footer": {
    ...
    "copyright": "RPT Digitalization Platform"
  },
  "navigation": {
    "items": [
      {
      ...
      {
        "path": "/about",
        "label": "About the Transformation"
      },
      {
        "path": "/portfolio",
        "label": "Portfolio"
